...
[assembly: InternalsVisibleTo("AlbanianXrm.SolutionPackager.Tool")]
namespace AlbanianXrm.WebResources
{
    [Export(typeof(IXrmToolBoxPlugin)),
       ExportMetadata("Name", "Albanian WebResources Commander"),
       ExportMetadata("Company", "Betim Beja, AlbanianXrm"),
       ExportMetadata("Description", "This tool simplifies syncronization of WebResources to a Dataverse Solution"),
    ...
    public class AlbanianXrmTool : PluginBase
    {
        public AlbanianXrmTool()
        {
        ...
        {
            return new WebResourcesCommanderTool(GetType());
        }
        ...
        private Assembly AssemblyResolveEventHandler(object sender, ResolveEventArgs args)
        {
            ...
            var commaIndex = args.Name.IndexOf(",", StringComparison.InvariantCulture);
            if (commaIndex == -1)
            {
                return null;
            ...
            var argName = args.Name.Substring(0, commaIndex);
